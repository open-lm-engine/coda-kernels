...
def _qknorm_rope_bwd(
    ...
    lanes_per_head = cutlass.const_expr(head_dim // (2 * vector_size))
    misc_utils.static_assert(mDX_packed.element_type.width == 2 * mDX.element_type.width)
    misc_utils.static_assert(mDQ_packed.element_type.width == 2 * mDQ.element_type.width)
    misc_utils.static_assert(mDK_packed.element_type.width == 2 * mDK.element_type.width)
    misc_utils.static_assert(mX_packed.element_type.width == 2 * mX.element_type.width)
